...
Examples:
  ...
  %(prog)s ~/Photos/graded --dry-run
    ...
    parser.add_argument("--output", "-o", type=str, default=None, help="Output video path (default: <input>/../timelapse.mp4)")
    parser.add_argument("--fps", type=int, default=None, help="Video frame rate (default: 25)")
    parser.add_argument("--crf", type=int, default=None, help="H.264 CRF quality: 0=lossless, 18=high, 23=default (default: 18)")
